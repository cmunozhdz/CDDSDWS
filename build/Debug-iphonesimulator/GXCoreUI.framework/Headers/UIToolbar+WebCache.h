...
/**
 * Integrates GXWebImage async downloading and caching of remote images with UIToolbar.
 */
@interface UIToolbar (WebCache)
 ...
 */
- (void)gxCancelBackgroundImageLoadForToolbarPosition:(UIBarPosition)topOrBottom barMetrics:(UIBarMetrics)barMetrics;
