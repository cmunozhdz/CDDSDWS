...
/**
 * Integrates GXWebImage async downloading and caching of remote images with UIBarButtonItem.
 */
@interface UIBarButtonItem (WebCache)
 ...
 */
- (void)gxCancelImageLoad;

/**
 * Cancel the current backgroundImage download
 */
- (void)gxCancelBackgroundImageLoadForState:(UIControlState)state barMetrics:(UIBarMetrics)barMetrics;
