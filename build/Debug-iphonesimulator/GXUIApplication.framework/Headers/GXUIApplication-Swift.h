...
#ifndef GXUIAPPLICATION_SWIFT_H
#define GXUIAPPLICATION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GXUIApplication",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface AppDelegate_Shared (SWIFT_EXTENSION(GXUIApplication)) <GXPreferenceViewControllerDelegate>
- (void)preferenceViewController:(GXPreferencesViewController * _Nonnull)controller didValidateModelForUrl:(NSString * _Nonnull)url;
@end


@interface AppDelegate_Shared (SWIFT_EXTENSION(GXUIApplication)) <GXUtilitiesDeveloperInfoExtension>
@property (nonatomic, readonly) BOOL gxShowDeveloperInfo;
@property (nonatomic, readonly) BOOL isDeveloperInfoExtensionDynamic;
@property (nonatomic, readonly) BOOL showDeveloperInfo;
@end

@protocol GXExtensionLibraryProtocol;
@class UIApplication;
@class NSObject;

@interface AppDelegate_Shared (SWIFT_EXTENSION(GXUIApplication))
- (void)initialSetup;
@property (nonatomic, readonly, copy) NSArray<id <GXExtensionLibraryProtocol>> * _Nonnull gxapplicationExtensionLibraries;
- (BOOL)gxapplication:(UIApplication * _Nonnull)app willOrDid:(BOOL)willEvent finishLaunchingWithOptions:(NSDictionary * _Nullable)launchOptions SWIFT_WARN_UNUSED_RESULT;
- (id _Nullable)gxDataValueForKey:(NSObject * _Nonnull)key SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface AppDelegate_Shared (SWIFT_EXTENSION(GXUIApplication)) <UIApplicationDelegate>
- (BOOL)application:(UIApplication * _Nonnull)app willFinishLaunchingWithOptions:(NSDictionary<UIApplicationLaunchOptionsKey, id> * _Nullable)launchOptions SWIFT_WARN_UNUSED_RESULT;
- (BOOL)application:(UIApplication * _Nonnull)app didFinishLaunchingWithOptions:(NSDictionary<UIApplicationLaunchOptionsKey, id> * _Nullable)launchOptions SWIFT_WARN_UNUSED_RESULT;
- (void)applicationDidBecomeActive:(UIApplication * _Nonnull)app;
- (void)applicationWillTerminate:(UIApplication * _Nonnull)app;
...
- (BOOL)application:(UIApplication * _Nonnull)app continueUserActivity:(NSUserActivity * _Nonnull)userActivity restorationHandler:(void (^ _Nonnull)(NSArray<id <UIUserActivityRestoring>> * _Nullable))restorationHandler SWIFT_WARN_UNUSED_RESULT;
...
@interface GXUIApplicationClass (SWIFT_EXTENSION(GXUIApplication))
...
SWIFT_CLASS_NAMED("GXUIApplicationExecutionEnvironment")
@interface GXUIApplicationExecutionEnvironment : NSObject
...
@interface GXUIApplicationExecutionEnvironment (SWIFT_EXTENSION(GXUIApplication)) <GXExecutionEnvironment>
...
@property (nonatomic, readonly, copy) NSArray<UIWindow *> * _Nonnull windows;
